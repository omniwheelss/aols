<?php
	...
	$Form_Fields[] = array('1','1','Event ID','ET_ID','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Event Name','Event_Name','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Start Date','Start_Date_Stamp','','*','E|N|0','','txtbox','Cal_T','');
	$Form_Fields[] = array('1','1','End Date','End_Date_Stamp','','*','E|N|0','','txtbox','Cal_T','');
	$Form_Fields[] = array('1','1','Location','Location','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Amount','Amount','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Reason','Reason','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Description','Description','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Status','Status','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date','Date_Stamp','','*','E|N|0','','txtbox','Cal_T','');
/*Text boxes
	...
	$Form_Fields[] = array('1','1','email','E_Mail','','*','E|N|0','','txtbox','','');*/
...
/*
	...
	$Photo_Fields['pho'] = array("pho","thumb","big",100,'','Yes','I');
