<?php
	...
	//Text boxes
	$Form_Fields[] = array('1','1','Account ID','Account_ID','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','User Type ID','User_Type_ID','','*','E|N|0','','txtbox','','');
	...
	$Form_Fields[] = array('1','1','Date_Stamp','Date_Stamp','','*','E|N|0','','txtbox','Cal_T','');
	$Form_Fields[] = array('1','1','Valid Till','Valid_Till','','*','E|N|0','','txtbox','Cal_T','');
