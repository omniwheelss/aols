...
<div class="gblNavigation" id="gblNavigation" style="border:solid 0px red;">
	...
	<?php
		...
		$Menus_Array = array ('Users','Payments','Activity','Events','General Info',);
		$Sub_Menus_Array = array ('E','E','E','E','E');
				
		//Extra menu Declaration
		$Extra_Menu_Array[0] = array (
									0 => array("Add_User.php | Add User Master","List_User.php | List User Master"),
									1 => array("Add_UserType.php | Add User Type","List_User_Type.php | List User Type")
								);
		$Extra_Menu_Array[1] = array (
									0 => array("Add_PaymentType.php | Add Payment Type","List_PaymentType.php | List Payment Type")
								);
