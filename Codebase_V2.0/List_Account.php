<?php
	...
	$Table_Name = "account";
	$Order_By = "Account_ID"; // Column name to be order and which order (asc or desc)
	$Records_Per_Page = 20;
	...
	$Search_Fields = array('Account_Name','Account_Address','Account_ID','Account_Phone','Account_Fax','Primary_Contact','Primary_Contact_Phone','Primary_Contact_Email','Secondary_Contact','Secondary_Contact_Phone','Secondary_Contact_Email','Date_Stamp');

	//List Fields
	$List_Fields[] = array('Account ID','Account_ID','','','');
	$List_Fields[] = array('Name','Account_Name','','','');
	$List_Fields[] = array('Address','Account_Address','','','');
	$List_Fields[] = array('Phone number','Account_Phone','','','');
	$List_Fields[] = array('Fax','Account_Fax','','','');
	$List_Fields[] = array('Primary contact','Primary_Contact','','','');
	$List_Fields[] = array('Primary contact phone number','Primary_Contact_Phone','','','');
	$List_Fields[] = array('Primary contact Email','Primary_Contact_Email','','','');
	$List_Fields[] = array('Secondary contact','Secondary_Contact','','','');
	$List_Fields[] = array('Secondary contact Phone Number','Secondary_Contact_Phone','','','');
	$List_Fields[] = array('Secondary contact Email','Secondary_Contact_Email','','','');
	$List_Fields[] = array('Date','Date_Stamp','','2','');
