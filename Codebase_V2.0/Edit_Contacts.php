<?php
	...
	$Form_Fields[] = array('1','1','Contact Name','Contact_Name','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Date Of Birth','DOB','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Address','Address','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Email','Email','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Phone Number','Phone_Number','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Mobile','Mobile','','*','E|N|0','','txtbox','','');
	$Form_Fields[] = array('1','1','Website','Website','','*','E|N|0','','txtbox','','');
